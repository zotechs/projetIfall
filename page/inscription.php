...
<!--===================inscription=================-->
    	...
    	<form style="width:100%" id="frml" method="post" action="serveur.php?option=verif"  style="">
	    ...
	    <?php
			...
			echo'	</select>';
			echo'	<label for="dat">Date de Naissance</label>';
			echo'	<input type="date" id="dat" name="dat" required="required" value="'.$tab['dat'].'">';
