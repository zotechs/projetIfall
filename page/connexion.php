...
<form class="con" method="post" action="test.php?option=connexion" style="margin-left:37%;width:50%;margin-top:1%; margin-bottom:7% ">
	<img src="./../image/user.png" style="margin-left: 18%;">
	<h1 style="font-size: 24px;font-weight: bolder;letter-spacing: -0.5px; margin-left:18%; ">Prestataire</h1>
	...
	<div style="border:solid 1px silver; width:52%; padding-left:2%;padding-top:1%;padding-bottom:2%; margin-top:1.5%; ;background-color:white;">
		<label>Nouvelle prestataire? <a href="inscription.php">S'inscrire</a></label>
	</div>
</form>
